...
public class testCoverage_Trulioo_Singapore_c03 extends common


{
	 public static final Logger log=Logger.getLogger(testCoverage_Trulioo_Singapore_c03.class.getName());
	 webelements webelements;
	
// call excel test data by this provider
	
	@DataProvider(name="trulioo Singapore C03")
	public String[][] getTestData()
	 {
		log.info("reading exceldata");
		String[][] testRecords=getData("GE_Trulioo_C03.xlsx", "Singapore");
		return testRecords;
	 }	
	

	@Test(dataProvider ="trulioo Singapore C03")
	...
	
	{
		...
		webelements.formVerificationSingapore(firstname, lastname, dob, nationalidnum, streetnumber, streetname, postalcode, phonenum, companyname);
