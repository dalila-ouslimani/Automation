...
public class testCoverage_Trulioo_LB_c4 extends common


{
	 public static final Logger log=Logger.getLogger(testCoverage_Trulioo_LB_c4.class.getName());
	 webelements webelements;
	
// call excel test data by this provider
	
	@DataProvider(name="trulioo Lebanon C03")
	public String[][] getTestData()
	 {
		log.info("reading exceldata");
		String[][] testRecords=getData("GE_Trulioo_C03.xlsx", "Lebanon");
		return testRecords;
	 }	
	

	@Test(dataProvider ="trulioo Lebanon C03")
	...
	
	{
		...
		webelements.formVerificationLebanon(firstname, lastname, dob, nationalidnum, streetnumber, streetname, cityname, statename, postalcode, phonenum, companyname);
